    ...
    $.fn.slideshow = function(settings) {
        ...
        this.each(function(){
            ...
            this.build    = function () {
                ...
                // triggers
                ext.bind('aslideshow:play', function() {
                    clearTimeout(_self.playId);
                    _self.playId = setTimeout(function(){ _self.play() }, _self.options.time);
                });
                
                ext.bind('aslideshow:next', function() {                    
                    clearTimeout(_self.playId);
                    _self.playId = setTimeout(function(){ _self.next() }, _self.options.time);
                });
                
                // filter content
                if (this.options.filter) {
                    ext.find('.aslideshow-content > br').remove();
                    ext.find('.aslideshow-content > hr').remove();
